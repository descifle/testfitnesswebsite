...
const DotSVG: React.FC<DefaultElementProps> = ({ className = "", onClick }) => {
    return (
        <svg 
        className={className} 
        onClick={ onClick !== null ? () => onClick() : () => {}} 
        height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 31.955 31.955" xmlSpace="preserve">
            <g>
